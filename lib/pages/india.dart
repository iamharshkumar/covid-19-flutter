    ...
    return Scaffold(
        ...
        body: indiaData == null
          ...
          return ExpansionTile(
            title: Text(indiaData[index]['state'], style: TextStyle(fontWeight: FontWeight.bold),),
            children: <Widget>[
              ListView.builder(
                  shrinkWrap: true,
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    indiaData[index]['districtData'][i]['district'],
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      "CONFIRMED:" +
                                          indiaData[index]['districtData'][i]['confirmed'].toString(),
                                      style: TextStyle(
                                    ...
                                    Text(
                                      "ACTIVE:" +
                                          indiaData[index]['districtData'][i]['active'].toString(),
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: Colors.blue),
                                    ),
                                    Text(
                                      "RECOVERED:" +
                                          indiaData[index]['districtData'][i]['recovered'].toString(),
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: Colors.green),
                                    ),
                                    Text(
                                      "DEATHS:" +
                                          indiaData[index]['districtData'][i]['deceased'].toString(),
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
